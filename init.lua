...
-- NOTE: I put it to 'n' to indicate normal mode, as I only want a click from my touchpad to be affecting vim in normal mode, not while editing
vim.opt.mouse = 'n'
...
-- Enable break indent
-- NOTE: newline starts on same indent as above, to keep it a block
...
-- NOTE: column on the left to display like linting errors or Git changes
vim.opt.signcolumn = 'yes'

-- Decrease update time
-- NOTE: Idle time (ms) before swpfile is written to disk
...
-- TODO: CHECK if you want to fix this:
